...
If you've researched getting a service dog, you've probably run into a lot of conflicting information — and a lot of services selling certifications that don't actually mean anything. Let's clear it up.
...
That's it. No vest required. No certification required. No registration required. The dog does not need to come from a program. **Owner-trained service dogs are fully legal under the ADA.**
...
- No certification or registration legally required
...
- Typically needs certification through an organization (AKC, APDT, or facility-specific)
...
**Training takes time.** A realistically trained service dog takes 18–24 months for programs, or 12–18 months for an experienced owner-trainer with professional help. Anyone telling you they can certify your dog in a weekend is lying to you.
...
6. **Certification prep** — we help you navigate the certification process if needed for your facility or employer
